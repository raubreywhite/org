...
#> Sourcing all code inside /tmp/RtmppJ3z4L/org_set_results_example/R into 
org::project$results_today
#> [1] "/tmp/RtmppJ3z4L/org_set_results_example/results_a/2026-08-20/"

# Point the project at a different results folder
org::set_results(file.path(home, "results_b"))
org::project$results_today
#> [1] "/tmp/RtmppJ3z4L/org_set_results_example/results_b/2026-08-20/"
