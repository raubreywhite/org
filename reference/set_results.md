...
#> Sourcing all code inside /tmp/RtmpAtqGV8/org_set_results_example/R into 
org::project$results_today
#> [1] "/tmp/RtmpAtqGV8/org_set_results_example/results_a/2026-08-06/"

# Point the project at a different results folder
org::set_results(file.path(home, "results_b"))
org::project$results_today
#> [1] "/tmp/RtmpAtqGV8/org_set_results_example/results_b/2026-08-06/"
