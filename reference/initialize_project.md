...
#> Sourcing all code inside /tmp/RtmptfyFT5/org_init_example/analysis3/R into 

# Folder locations, both on the returned environment and on org::project
proj$results_today # Today's results folder
#> [1] "/tmp/RtmptfyFT5/org_init_example/results/2026-08-20/"
proj$raw # Raw data folder
#> [1] "/tmp/RtmptfyFT5/org_init_example/raw/"
org::project$results_today
#> [1] "/tmp/RtmptfyFT5/org_init_example/results/2026-08-20/"
