...
#> Sourcing all code inside /tmp/RtmpAtqGV8/org_project_example/R into 

# Every folder is now available from anywhere in the analysis
org::project$home
#> [1] "/tmp/RtmpAtqGV8/org_project_example/"
org::project$results
#> [1] "/tmp/RtmpAtqGV8/org_project_example/results/"
org::project$results_today
#> [1] "/tmp/RtmpAtqGV8/org_project_example/results/2026-08-06/"
org::project$data_raw
#> [1] "/tmp/RtmpAtqGV8/org_project_example/data_raw/"
