...
The [splverse](https://www.csids.no/packages.html) is a set of R packages developed to help solve problems that frequently occur when performing infectious disease surveillance.
...
options(
  repos = structure(c(
    SPLVERSE  = "https://www.csids.no/drat/",
